...
// Proses penyimpanan perubahan sistem jika form disubmit
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update data sistem
    $updateSistem = mysqli_query($conn, "UPDATE sistem SET apk_name = '$apk_name', pajak = '$pajak', diskon_mb = '$diskon_mb', antar = '$antar', antar_jemput = '$antar_jemput'");
    if ($updateSistem) {
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row mt-5">
                                                    <p class="col-sm-3  mb-0 mb-sm-3">Nama Aplikasi</p>
                                                ...
                                                <div class="row mt-5">
                                                    <p class="col-sm-3  mb-0 mb-sm-3">Pajak</p>
                                                    <p class="col-sm-2 text-sm-left">:</p>
                                                    <p class="col-sm-2">
                                                ...
                                                <div class="row mt-5">
                                                    <p class="col-sm-3  mb-0 mb-sm-3">Diskon</p>
                                                    <p class="col-sm-2 text-sm-left">:</p>
                                                    <p class="col-sm-2">
                                                ...
                                                <div class="row mt-5">
                                                    <p class="col-sm-3  mb-0 mb-sm-3">Biaya Antar</p>
                                                    <p class="col-sm-2 text-sm-left">:</p>
                                                    <p class="col-sm-2"><span>Rp. </span>
                                                        <?= number_format($sistem['antar']); ?>
                                                    </p>
                                                </div>
                                                <div class="row mt-5">
                                                    <p class="col-sm-3  mb-0 mb-sm-3">Biaya Antar-Jemput</p>
                                                    <p class="col-sm-2 text-sm-left">:</p>
                                                    <p class="col-sm-2"><span>Rp. </span>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary btn-block">Simpan
                                                                Perubahan</button>
                                                        </form>
                                                    </div>
                                                </div>
